        ...
        <form id="frmMostrarCuerpoProd">
            <table class="table" id="tablaMostrarCuerpoProd">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <button class="btn btn-warning waves-light waves-effect button" type="button" name="btnModificar" id="btnModificar"   onclick="location.href='ModificarProducto.jsp?codigoP=<%=P.getCodigoP() %>'"> Modificar</button>
                    </td>
                    <td class="Opcion">
                         <button class="btn btn-danger waves-light waves-effect button" type="button" name="btnEliminar" id="btnEliminar"  onclick="location.href='Servlet_Prod?codigoP=<%=P.getCodigoP() %>&&accion=eliminar'">Eliminar</button>
                    </td>
                </tr>
