...
<html>
    ...
    <body >
        ...
        <form id="frmMostrarCabeceraUsuario">
            <table class="table" id="tablaMostrarCabeceraUsuario">
                <tr>
                    <th>
  ...
  <tr>
   ...
   <%
                ...
                <tr>
                    ...
                    <td class="Opcion">
                         <button class="btn btn-danger waves-light waves-effect button" type="button" name="btnEliminar" id="btnEliminar"  
                                onclick="location.href='Servlet_Usu?codigoU=<%=usu.getCodigoUsuario()%>&&accion=eliminar'">eliminar</button>
